...
Lub oil pressure = st.number_input("Oil Pressure[Bar] (Max 7.27)", value=3.5)
lub oil temp = st.number_input("Oil Temperature[Bar] (Max 89.59)", value=45)
Coolant temp = st.number_input("Coolant Temperature[C] (Max 195.53)", value=100)
...
Engine rpm = st.number_input("Rpm (Max 2239)", value=1000)


input_df = pd.DataFrame({
    
    "Oil Temperature[Bar] (Max 89.59)": [lub oil temperature],
    "Coolant Temperature[C] (Max 195.53)": [Coolant temp],
    "Oil Pressure[Bar] (Max 7.27)": [Lub oil pressure],
    "Fuel Pressure[Bar] (Max 21.14)": [Fuel pressure],
    "Coolant Pressure[Bar] (Max 7.48)": [Coolant pressure]
    "Rpm (Max 2239)": [Engine rpm]
})
